...
//    }
    ...
    void testKuendigenAlle_sollFunktionieren_dreiMA_zweiHubert_returns2() {
        try {
            ...
            //System.out.println(ma1.getClass());
    ...
    void testKuendigenIndex_sollFunktionieren_einFreelacer_returnsFreelacer() {
        try {
            ...
            try {
                assertEquals(mitarbeiter, personalbuero.kuendigen(0));
    ...
    void testToCSVString() {
        try {
            Mitarbeiter mitarbeiter = new Angestellter("Hubert", Year.of(2000), Year.now());
            System.out.println(mitarbeiter.toCSVString());
            Mitarbeiter mitarbeiter1 = new Arzt("Hubert", Year.of(2000), Year.now(), 10, 1000.0);
            System.out.println(mitarbeiter1.toCSVString());
            Mitarbeiter mitarbeiter2 = new Freelancer("Hubert", Year.of(2000), Year.now(), 100, 10);
            System.out.println(mitarbeiter2.toCSVString());
            System.out.println();
            Personalbuero personalbuero1 = new Personalbuero();
            personalbuero1.aufnehmen(mitarbeiter);
            personalbuero1.aufnehmen(mitarbeiter1);
            personalbuero1.aufnehmen(mitarbeiter2);
            System.out.println(personalbuero1.toCSVString());
            personalbuero1.writePersonalToCSV();
    ...
    @Test
    void testReadPersonalFromCSV_personalbueroLeer() {
        Personalbuero personalbuero1 = new Personalbuero();
        System.out.println(personalbuero1); // leer
        System.out.println();
        try {
            personalbuero1.readPersonalFromCSV();
            System.out.println(personalbuero1); // importierte MAs
            System.out.println();
        } catch (PersonalException e) {
            System.out.println(e.getMessage());
            fail();
    ...
    @Test
    void testReadPersonalFromCSV_personalbueroZweiMa() {
        try {
            Personalbuero personalbuero1 = new Personalbuero();
            personalbuero1.aufnehmen(new Angestellter("Hr. Mohamad", Year.of(2006), Year.now()));
            personalbuero1.aufnehmen(new Freelancer());
            System.out.println(personalbuero1); // leer
            System.out.println();
